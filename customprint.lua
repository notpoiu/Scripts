...
local custom_print_lib = {}

function custom_print_lib.create_log(msg, img, clr)
...
function custom_print_lib.create_progressbar(params)
    ...
    local message = create_log(msg, img, clr)
    local progress = 0
